window.__TASKSHIFT_LOGIN_TRANSLATIONS__ = {
  ru: {
    ...
    description:
      "Введите токен администратора из <code>configs/.env</code>, чтобы просматривать активный снимок кластера и редактировать конфиги.",
  ...
  en: {
    ...
    description:
      "Enter the admin access token from <code>configs/.env</code> to inspect the active cluster snapshot and edit config files.",
...
window.__TASKSHIFT_APP_TRANSLATIONS__ = {
  ru: {
    ...
    "brand.description":
      "Просматривайте снимок кластера, редактируйте конфиги и управляйте служебными вкладками из одной панели.",
    ...
    "tab.logs.label": "Логи",
    "tab.logs.caption":
      "Структурированный просмотр `taskshift.log` с поиском и фильтрами.",
    "tab.jobs.label": "Задачи",
    "tab.jobs.caption":
      "Журнал запусков задач с поиском по `job_id` и статусу.",
    ...
    "side.edit.text":
      "Редактирование cluster config затрагивает файл, который сейчас используется планировщиком.",
    "button.logout": "Выйти",
    ...
    "panel.logs.subtitle":
      "Структурированный просмотр runtime-сообщений из `logs/taskshift.log`.",
    ...
    "system.queue.loading":
      "Загрузка задач, для которых была попытка запуска в последнем проходе шедулера.",
    ...
    "system.queueSummaryTemplate":
      "Попыток запуска: {attempted}, задач в очереди на снимке: {pending}, running snapshot: {running}.",
  ...
  en: {
    ...
    "brand.description":
      "Inspect the active cluster snapshot, edit live config files, and keep room for future tabs without changing the operating model.",
    ...
    "tab.logs.label": "Logs",
    "tab.logs.caption":
      "Structured view for `taskshift.log` with search and level filters.",
    "tab.jobs.label": "Jobs",
    "tab.jobs.caption":
      "Launch-event journal with search by job id and status.",
    "side.auth.title": "Auth",
    "side.auth.text":
      "Admin access is protected by `ADMIN_PANEL_TOKEN` from `configs/.env`.",
    "side.edit.title": "Editing",
    "side.edit.text":
      "Cluster edits target the currently active cluster config file used by the scheduler.",
    ...
    "panel.logs.subtitle":
      "Structured view of taskshift runtime messages from `logs/taskshift.log`.",
    ...
    "system.queue.loading":
      "Loading jobs that were attempted on the latest scheduler pass.",
    ...
    "system.queueSummaryTemplate":
      "Launch attempts: {attempted}, queued jobs in snapshot: {pending}, running snapshot: {running}.",
    "system.queueEmpty":
      "No launch attempts were made on the last scheduler pass.",
