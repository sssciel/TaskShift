...
RAW_JOBS_CACHE_FILE = "raw_jobs.json"
...
GET_HISTORICAL_JOBS_BASE_QUERY = """SELECT id_job, job_name, timelimit, state, priority, constraints,
                        cpus_req, nodes_alloc, time_start, time_end, time_submit, time_eligible,
                        mod_time, tres_req, nodelist, `partition`
                        FROM linux_job_table
                        WHERE deleted=0 AND time_start > 0"""

GET_ACTIVE_JOBS_BASE_QUERY = """SELECT id_job, job_name, timelimit, state, priority, constraints,
                        cpus_req, nodes_alloc, time_start, time_end, time_submit, time_eligible,
                        mod_time, tres_req, nodelist, `partition`
                        FROM linux_job_table
